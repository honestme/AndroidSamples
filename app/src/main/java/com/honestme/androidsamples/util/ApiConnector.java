package com.honestme.androidsamples.util;
...
public class ApiConnector {
    ...
    private static String urlBase = "http://www.baidu.com";
    ...
    public static void get(String request,RequestParams params, JsonHttpResponseHandler handler) {


        client.setTimeout(10000);
        client.get(getAbsoluteUrl(request),params , handler);
    }

    public static void post(String request,RequestParams params,JsonHttpResponseHandler handler){
        client.post(getAbsoluteUrl(request),params,handler);
    }
